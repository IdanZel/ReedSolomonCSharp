...
public static class reed_solomon_base
{
    public const uint datum = 0; // a data element's bits
    public const uint symbol = 0; // a symbol's bits
    public const uint size = 0; // R-S block size (maximum total symbols)
    public const uint nroots = 0; // R-S roots (parity symbols)
    public const uint load = 0; // R-S net payload (data symbols)
    public const uint poly = 0; // R-S Polynomial
    public const uint fcr = 0; // R-S First Consecutive Root index
    public const uint prim = 0; // R-S Primitive Element index
    public const bool dual = false; // R-S Berleskamp Dual-basis encoding

    // Berleskamp dual-basis tables only apply to 8-bit symbols
    public static readonly byte[] into_dual =
    [
    ...
    public static readonly byte[] from_dual =
    [
